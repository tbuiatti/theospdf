...
static SeqStrings gCommandNames =
    ...
    "CmdToggleToolbar\0" "CmdToggleScrollbars\0" "CmdToggleMenuBar\0"
    "CmdCopySelection\0" "CmdTranslateSelectionWithGoogle\0" "CmdTranslateSelectionWithDeepL\0"
    "CmdSearchSelectionWithGoogle\0" "CmdSearchSelectionWithBing\0" "CmdSearchSelectionWithWikipedia\0"
    "CmdSearchSelectionWithGoogleScholar\0" "CmdSelectAll\0" "CmdNewWindow\0"
    "CmdDuplicateInNewWindow\0" "CmdDuplicateInNewTab\0" "CmdCopyImage\0"
    "CmdCopyLinkTarget\0" "CmdCopyComment\0" "CmdCopyFilePath\0"
    "CmdScrollUp\0" "CmdScrollDown\0" "CmdScrollLeft\0"
    "CmdScrollRight\0" "CmdScrollLeftPage\0" "CmdScrollRightPage\0"
    "CmdScrollUpPage\0" "CmdScrollDownPage\0" "CmdScrollDownHalfPage\0"
    ...
    "CmdZoom1600\0" "CmdZoom800\0" "CmdZoom400\0"
    "CmdZoom200\0" "CmdZoom150\0" "CmdZoom125\0"
    "CmdZoom100\0" "CmdZoom50\0" "CmdZoom25\0"
    "CmdZoom12_5\0" "CmdZoom8_33\0" "CmdZoomFitContent\0"
    "CmdZoomCustom\0" "CmdZoomIn\0" "CmdZoomOut\0"
    "CmdZoomFitWidthAndContinuous\0" "CmdZoomFitPageAndSinglePage\0" "CmdContributeTranslation\0"
    "CmdOpenWithKnownExternalViewerFirst\0" "CmdOpenWithExplorer\0" "CmdOpenWithDirectoryOpus\0"
    "CmdOpenWithTotalCommander\0" "CmdOpenWithDoubleCommander\0" "CmdOpenWithAcrobat\0"
    "CmdOpenWithFoxIt\0" "CmdOpenWithFoxItPhantom\0" "CmdOpenWithPdfXchange\0"
    "CmdOpenWithXpsViewer\0" "CmdOpenWithHtmlHelp\0" "CmdOpenWithPdfDjvuBookmarker\0"
    "CmdOpenWithKnownExternalViewerLast\0" "CmdOpenSelectedDocument\0" "CmdPinSelectedDocument\0"
    "CmdForgetSelectedDocument\0" "CmdExpandAll\0" "CmdCollapseAll\0"
    "CmdSaveEmbeddedFile\0" "CmdOpenEmbeddedPDF\0" "CmdSaveAttachment\0"
    "CmdOpenAttachment\0" "CmdOptions\0" "CmdAdvancedOptions\0"
    "CmdAdvancedSettings\0" "CmdChangeLanguage\0" "CmdCheckUpdate\0"
    ...
    "CmdCreateAnnotStrikeOut\0" "CmdCreateAnnotRedact\0" "CmdCreateAnnotStamp\0"
    "CmdCreateAnnotCaret\0" "CmdCreateAnnotInk\0" "CmdCreateAnnotPopup\0"
    "CmdCreateAnnotFileAttachment\0" "CmdInvertColors\0" "CmdTogglePageInfo\0"
    "CmdToggleZoom\0" "CmdNavigateBack\0" "CmdNavigateForward\0"
    "CmdToggleCursorPosition\0" "CmdOpenNextFileInFolder\0" "CmdOpenPrevFileInFolder\0"
    "CmdCommandPalette\0" "CmdShowLog\0" "CmdClearHistory\0"
...
static i32 gCommandIds[] = {
    ...
    CmdToggleToolbar, CmdToggleScrollbars, CmdToggleMenuBar,
    CmdCopySelection, CmdTranslateSelectionWithGoogle, CmdTranslateSelectionWithDeepL,
    CmdSearchSelectionWithGoogle, CmdSearchSelectionWithBing, CmdSearchSelectionWithWikipedia,
    CmdSearchSelectionWithGoogleScholar, CmdSelectAll, CmdNewWindow,
    CmdDuplicateInNewWindow, CmdDuplicateInNewTab, CmdCopyImage,
    CmdCopyLinkTarget, CmdCopyComment, CmdCopyFilePath,
    CmdScrollUp, CmdScrollDown, CmdScrollLeft,
    CmdScrollRight, CmdScrollLeftPage, CmdScrollRightPage,
    CmdScrollUpPage, CmdScrollDownPage, CmdScrollDownHalfPage,
    ...
    CmdZoom1600, CmdZoom800, CmdZoom400,
    CmdZoom200, CmdZoom150, CmdZoom125,
    CmdZoom100, CmdZoom50, CmdZoom25,
    CmdZoom12_5, CmdZoom8_33, CmdZoomFitContent,
    CmdZoomCustom, CmdZoomIn, CmdZoomOut,
    CmdZoomFitWidthAndContinuous, CmdZoomFitPageAndSinglePage, CmdContributeTranslation,
    CmdOpenWithKnownExternalViewerFirst, CmdOpenWithExplorer, CmdOpenWithDirectoryOpus,
    CmdOpenWithTotalCommander, CmdOpenWithDoubleCommander, CmdOpenWithAcrobat,
    CmdOpenWithFoxIt, CmdOpenWithFoxItPhantom, CmdOpenWithPdfXchange,
    CmdOpenWithXpsViewer, CmdOpenWithHtmlHelp, CmdOpenWithPdfDjvuBookmarker,
    CmdOpenWithKnownExternalViewerLast, CmdOpenSelectedDocument, CmdPinSelectedDocument,
    CmdForgetSelectedDocument, CmdExpandAll, CmdCollapseAll,
    CmdSaveEmbeddedFile, CmdOpenEmbeddedPDF, CmdSaveAttachment,
    CmdOpenAttachment, CmdOptions, CmdAdvancedOptions,
    CmdAdvancedSettings, CmdChangeLanguage, CmdCheckUpdate,
    ...
    CmdCreateAnnotStrikeOut, CmdCreateAnnotRedact, CmdCreateAnnotStamp,
    CmdCreateAnnotCaret, CmdCreateAnnotInk, CmdCreateAnnotPopup,
    CmdCreateAnnotFileAttachment, CmdInvertColors, CmdTogglePageInfo,
    CmdToggleZoom, CmdNavigateBack, CmdNavigateForward,
    CmdToggleCursorPosition, CmdOpenNextFileInFolder, CmdOpenPrevFileInFolder,
    CmdCommandPalette, CmdShowLog, CmdClearHistory,
...
SeqStrings gCommandDescriptions =
    ...
    "Toggle Toolbar\0" "Toggle Scrollbars\0" "Toggle Menu Bar\0"
    "Copy Selection\0" "Translate Selection with Google\0" "Translate Selection With DeepL\0"
    "Search Selection with Google\0" "Search Selection with Bing\0" "Search Selection with Wikipedia\0"
    "Search Selection with Google Scholar\0" "Select All\0" "Open New SumatraPDF Window\0"
    "Open Current Document In New Window\0" "Open Current Document In New Tab\0" "Copy Image\0"
    "Copy Link Target\0" "Copy Comment\0" "Copy File Path\0"
    "Scroll Up\0" "Scroll Down\0" "Scroll Left\0"
    "Scroll Right\0" "Scroll Left By Page\0" "Scroll Right By Page\0"
    "Scroll Up By Page\0" "Scroll Down By Page\0" "Scroll Down By Half Page\0"
    ...
    "Zoom: 1600%\0" "Zoom: 800%\0" "Zoom: 400%\0"
    "Zoom: 200%\0" "Zoom: 150%\0" "Zoom: 125%\0"
    "Zoom: 100%\0" "Zoom: 50%\0" "Zoom: 25%\0"
    "Zoom: 12.5%\0" "Zoom: 8.33%\0" "Zoom: Fit Content\0"
    "Zoom: Custom...\0" "Zoom In\0" "Zoom Out\0"
    "Zoom: Fit Width And Continuous\0" "Zoom: Fit Page and Single Page\0" "Contribute Translation\0"
    "don't use\0" "Open Directory In Explorer\0" "Open Directory In Directory Opus\0"
    "Open Directory In Total Commander\0" "Open Directory In Double Commander\0" "Open in Adobe Acrobat\0"
    "Open in Foxit Reader\0" "Open in Foxit PhantomPDF\0" "Open in PDF-XChange\0"
    "Open in Microsoft Xps Viewer\0" "Open in Microsoft HTML Help\0" "Open With Pdf&Djvu Bookmarker\0"
    "don't use\0" "Open Selected Document\0" "Pin Selected Document\0"
    "Remove Selected Document From History\0" "Expand All\0" "Collapse All\0"
    "Save Embedded File...\0" "Open Embedded PDF\0" "Save Attachment...\0"
    "Open Attachment\0" "Options...\0" "Advanced Options...\0"
    "Advanced Settings...\0" "Change Language...\0" "Check For Updates\0"
    ...
    "Create Strike Out Annotation\0" "Create Redact Annotation\0" "Create Stamp Annotation\0"
    "Create Caret Annotation\0" "Create Ink Annotation\0" "Create Popup Annotation\0"
    "Create File Attachment Annotation\0" "Invert Colors\0" "Toggle Page Info\0"
    "Toggle Zoom\0" "Navigate Back\0" "Navigate Forward\0"
    "Toggle Cursor Position\0" "Open Next File In Folder\0" "Open Previous File In Folder\0"
    "Command Palette\0" "Show Logs\0" "Clear History\0"
